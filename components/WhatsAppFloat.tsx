...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-3 rounded-full border border-[var(--brand-primary)] bg-[var(--brand-primary-hover)] px-3 py-3 text-white shadow-[0_24px_60px_rgba(0,119,182,0.24)] transition duration-200 hover:scale-[1.02] hover:bg-[var(--brand-secondary)] sm:bottom-6 sm:right-6"
    >
